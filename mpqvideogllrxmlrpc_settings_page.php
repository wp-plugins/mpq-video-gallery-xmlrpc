<div class="wrap">
<h2>MPQ Video Gallery Plugin XML-RPC API</h2>
<p>Adjust the settings below for your API usage needs.</p>
...
<input type="hidden" name="hosted_button_id" value="VLFPQMLSD9MJC">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
<hr/>
<h2>MPQ Video Gallery Plugin XML-RPC API Settings</h2>
...
<p>Adjusting the namespace value will require changes to the code you use to
    ...
    namespace for the additonal functions of this plugin is "mpqvideogllrxmlrpc_extapi". If you
    change this namespace value, your code will need to reflect your selected
    namespace.
</p>

    <?php settings_fields( 'mpqvideogllrxmlrpc_extapi_settings' ); ?>
    Namespace: <input type="text" name="namespace" value="<?php echo get_option('mpqvideogllrxmlrpc_namespace'); ?>" />
<p>All of the the following functions are defined and available within WordPress
    ...
    <br clear="all" />
    <?php
        asort($mpqvideogllrxmlrpc_extapi_available_functions);
        foreach ($mpqvideogllrxmlrpc_extapi_available_functions as $function) :
    ?>
    <div style="float: left; width: 300px; height: 25px; padding: 5px;">
        <input type="checkbox" name="mpqvideogllrxmlrpc_allowed_functions[]" value="<?php echo $function; ?>" <?php echo (in_array($function, get_option('mpqvideogllrxmlrpc_allowed_functions'))) ? 'CHECKED' : ''; ?> /><?php echo $function . "<br>"; ?>
    </div>
    <?php
        endforeach;
    ?>
